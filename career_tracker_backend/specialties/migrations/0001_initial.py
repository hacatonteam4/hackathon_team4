    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.ManyToManyField(related_name='grades_digrections', to='specialties.Skill')),
                ('specialization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grades_digrections', to='specialties.specialization')),
            ],
            options={
